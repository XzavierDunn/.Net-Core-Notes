...
namespace AuthenticationTutorial
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    options.AddPolicy("AdminAndPowerUser", policy => policy.RequireRole("Admin", "Poweruser"));
            //});
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "AuthenticationTutorial", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AuthenticationTutorial v1"));
            }
